...
router.get("/registerdUsers", masterController.getRegisterdUsers);
router.post("/partiallyReviewed", masterController.partiallyReviewed);

//Master Client-Admin
router.delete(
  "/deleteUserFromClientAdmin/:userId",
  masterController.deleteUserFromClientAdmin
);
...
//clientAdmin
router.get(
  "/getCompanyDetailsForAdmin/:adminId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.getCompanyDetailsForAdmin
);
router.post(
  "/filledByAdmin/:adminId/:companyId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.filledByAdmin
);

router.post(
  "/adminApprovedComDir/:adminId/:comDirId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.adminApprovedComDir
);
router.post(
  "/adminApprovedRequest/:adminId/:changePasswordId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.adminChangedPassword
);
router.get(
  "/getCompanyUpdateForAdmin/:adminId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.getCompanyUpdateForAdmin
);
router.get(
  "/getPersonalUpdateForAdmin/:adminId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.getPersonalUpdateForAdmin
);
router.put(
  "/updateCompany/:adminId/:updateCompanyId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.updateCompany
);
router.put(
  "/updatePersonal/:adminId/:updatePersonalId",
  adminAuth.authentication,
  adminAuth.authorization,
  adminController.updatePersonal
);
...
router.get(
  "/getSuperAdminDetails/:superAdminId",
  superAdminAuth.authentication,
  superAdminAuth.authorization,
  superAdminController.getSuperAdminDetails
);
router.get(
  "/getCompanyDetailsForsuperAdmin/:superAdminId",
  superAdminAuth.authentication,
  superAdminAuth.authorization,
  superAdminController.getCompanyDetailsForsuperAdmin
);
router.post(
  "/filledBysuperAdmin/:superAdminId/:companyId",
  superAdminAuth.authentication,
  superAdminAuth.authorization,
  superAdminController.filledBysuperAdmin
);
...
router.get(
  "/getCompanyDetails/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.getCompanyDetails
);
router.get(
  "/getpersonalinfo/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.getClientPersonalInfo
);
router.post(
  "/changePassword/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.changePassword
);
router.post(
  "/commercialDir/:clientId",
  aws.awsLinkProfile,
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.commercialDir
);
router.post(
  "/marketingDetails/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.marketingDetails
);
router.put(
  "/updateCompanyDetails/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.updateCompanyDetails
);
router.put(
  "/updatePersonalDetalis/:clientId",
  clientAuth.authentication,
  clientAuth.authorization,
  clientController.updatePersonalDetails
);
...
router.post(
  "/createRecommendationLetter/:companyId",
  clientAuth.authentication,
  clientAuth.authorization,
  aws.recoDoc,
  recomendationLetterController.createRecomendationLetter
);
...
//WINGS
router.post(
  "/createExportWing/:companyId",
  aws.awsDoc,
  wingsController.createExportWing
);
...
router.post(
  "/clientB2BColloboration/:clientId",
  B2BRegistration.clientB2BColloboration
);

//MEMBER SHIP SERVICES
router.post(
  "/membershipservices/:clientId",
...
router.post(
  ...
  aws.awsLinkProfile,
  aws.awsLinkEmployeeSignature,
  administrationController.registerAdministration
);
router.post(
  "/loginAdministration",
  administrationController.loginAdministration
);
router.post("/loginHR", administrationController.loginHR);
router.get(
  "/getMyaccount/:employeeId",
  auth.authentication,
  administrationController.getMyaccount
);
router.post(
  "/administration/forgotPassword",
  administrationController.forgotPasword
);
router.get(
  "/administration/resetPassword/:token",
  administrationController.resetPassword
);

// JD
//for first Time clicking
router.post(
  "/createEmployeeJd/:employeeId",
  auth.authentication,
  auth.authorization,
  employeeJdController.createEmployeeJd
);
//for next Line of JD
...
router.post(
  "/requestForExtend/:employeeId/:jdId",
  auth.authentication,
  auth.authorization,
  employeeJdController.requestForExtend
);
router.post(
  "/logOutJd/:employeeId/:jdId",
  auth.authentication,
  auth.authorization,
  employeeJdController.logOut
);
...
//HR
router.post(
  "/giveDataOfEmployee/:employeeId",
  auth.authentication,
  auth.authorizationForHr,
  employeeJdController.giveDataOfEmployee
);
router.get(
  "/getAllEmpData/:employeeId",
  auth.authentication,
  auth.authorizationForHr,
  administrationController.getEmpData
);
router.put(
  "/updateInfo/:employeeId/:normalEmployee",
  auth.authentication,
  auth.authorizationForHr,
  administrationController.updateInfo
);
...
router.post(
  "/extendByHr/:employeeId",
  auth.authentication,
  auth.authorizationForHr,
  employeeJdController.extendByHr
);
router.get(
  "/getWantedAdministrationList/:employeeId/:normalEmployee",
  auth.authentication,
  auth.authorizationForHr,
  employeeJdController.getWantedAdministrationList
);
router.get(
  "/getWantedListByDate/:employeeId/:normalEmployee",
  auth.authentication,
  auth.authorizationForHr,
  employeeJdController.getWantedListByDate
);
router.get(
  "/getExtendData/:employeeId",
  auth.authentication,
  auth.authorizationForHr,
  employeeJdController.getExtendData
);
router.delete(
  "/deleteEmp/:employeeId/:normalEmployee",
  auth.authentication,
  auth.authorizationForHr,
  administrationController.deleteEmployee
);
